...
var hsp = require("hsp/rt"), klass = require("hsp/klass"), layout = require("./layout.hsp.js"), samples = require("../samples/samples"), jx = require("./jx"), md = require("./markdown"), json = require("hsp/json");
...
var Playground = module.exports = klass({
    ...
    compileAndUpdate : function (fileName, newCode) {
        ...
        var self = this;
        var res = compiler.compile(newCode, fileName);
            ...
            try {
                ...
                var code2 = (['try {', res.code, '} catch(ex) {', 'var Playground=require("playground/playground");',
