...
var personList =exports.personList = require("hsp/rt").template(["persons"], function(n){
  var _personDescription;try {_personDescription=personDescription} catch(e) {};
...
var personDescription =exports.personDescription = require("hsp/rt").template(["person"], function(n){
  var _item;try {_item=item} catch(e) {};
